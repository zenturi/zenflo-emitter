...
HX_LOCAL_STACK_FRAME(_hx_pos_5c74e9f0f4a640e0_173_loop,"sys.thread.EventLoop","loop",0x33ddc657,"sys.thread.EventLoop.loop","/usr/local/lib/haxe/std/sys/thread/EventLoop.hx",173,0xbeb01246)
namespace sys{
namespace thread{
...
void EventLoop_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_5c74e9f0f4a640e0_173_loop)
